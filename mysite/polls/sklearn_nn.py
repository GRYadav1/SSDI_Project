...
def train_model():
    data = pd.read_csv("E:/Chrome-Downloads/NewProject/mysite/polls/data/train_data.csv")
    ...
    print("Hi")
    #ret=test_Model('data/test/066/08_066.png','data/test/066_forg/04_0211066.PNG',clf)
    print(ret)
    return clf


#test_Model('data/test/066/08_066.png','data/test/066_forg/04_0211066.PNG',train_model())
